                        ...
                        <li class="nav-item">
                           ...
                           <li class="nav-item colorletra">
                            ...
                            <li class="nav-item colorletra">
                             ...
                             <li class="nav-item colorletra">
                              <a class="nav-link colorletra ajuste-letra2" href="login.php"  tabindex="-1" aria-disabled="true">Login</a>           
                              </li>

                               <li class="nav-item colorletra">
                              <a class="nav-link colorletra ajuste-letra2" href="Registro.php" tabindex="-1" aria-disabled="true">Register</a>           
                              </li>
