...
<head>
    ...
    <script type="text/javascript">alert('BIENVENIDO '<?php require'conexion.php';$email=$_POST['email'];  echo 
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                           ...
                           <li class="nav-item colorletra">
                              <a class="nav-link colorletra ajuste-letra2" href="Rutinas.php" tabindex="-1" aria-disabled="true">Asignar Rutinas</a>

                            <li class="nav-item colorletra">
                              <a class="nav-link colorletra ajuste-letra2" href="listado.php" tabindex="-1" aria-disabled="true">Listado Rutinas</a> 
                          </li>
                          <li class="nav-item colorletra">
                              <a class="nav-link colorletra ajuste-letra2" href="listadodi.php" tabindex="-1" aria-disabled="true">Listado Dietas</a>

                          
                            <li class="nav-item colorletra">
                                <a class="nav-link colorletra ajuste-letra3" href="dieta.php" tabindex="-1" aria-disabled="true">Asignar Dietas</a>
                              </li>
